    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Aadhar_no', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='datacenter.aadhar_Database')),
            ],
        ),
        migrations.CreateModel(
            name='College_db',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(choices=[('Govt', 'govt'), ('public', 'public'), ('private', 'private'), ('other', 'other')], max_length=30)),
